...
RP_MySQLConfig.Host = "87.106.118.246" -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
...
RP_MySQLConfig.Password = "4IzGsWTEJk" -- This is the Password to log in on the MySQL server,
