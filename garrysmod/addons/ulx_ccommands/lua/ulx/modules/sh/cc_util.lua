...
freeway_administrade_toggle = freeway_administrade_toggle or {}

function ulx.administrate(calling_ply, bRevoke)
	if freeway_administrade_toggle[calling_ply:UserID()] then
		...
		calling_ply:ChatPrint("Du bist nicht mehr im Administrate")
		freeway_administrade_toggle[calling_ply:UserID()] = false
	else
		...
		calling_ply:ChatPrint("Du bist im Administrate")
		freeway_administrade_toggle[calling_ply:UserID()] = true
	end
end
